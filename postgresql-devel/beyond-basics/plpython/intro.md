This scenario gives you a quick introduction to using Python as an embedded langauge in PostgreSQL. The database has already been started and R has been installed into the learning environment as well. 
