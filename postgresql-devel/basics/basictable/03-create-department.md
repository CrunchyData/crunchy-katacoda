...
``` {{execute}}
  ...
  - department_number    
      - is of data type **INTEGER**, the GENERATED BY DEFAULT generated as **IDENTITY** also instructs
  ...
  - department_name    
      - is of data type **VARCHAR** character varying(n), where n is a positive
  ...
  I hope you are following let's continue.
