...
docker run -d --network mybridge -p 5050:5050 -e PGADMIN_SETUP_EMAIL=steve.pousty@gmail.com -e PGADMIN_SETUP_PASSWORD=password --name=pgadmin crunchydata/crunchy-pgadmin4:centos7-11.4-2.4.1 
