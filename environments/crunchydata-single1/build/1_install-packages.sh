...
yum install -y postgresql11 postgres11-server  pgbackrest postgresql-contrib postgis25_11 pgadmin4 unzip
/usr/pgsql-11/bin/postgresql-11-setup initdb

systemctl start postgresql11
systemctl enable postgresql11
